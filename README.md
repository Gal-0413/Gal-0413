## Olá!!
   ...
   - Buscando atuar na area de `Analista de Dados`
   - Atualmente aprofundando meus conhecimentos em `SQL`
...
- [ ] Melhorar habilidades no MYSQL
- [x] Iniciar treinamento e praticas em tabelas
- [ ] Melhorar nivel inglês
